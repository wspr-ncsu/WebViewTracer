...
https://codeshare.frida.re/@ispiropoulos/root-and-ssl-bypass/
https://codeshare.frida.re/@akabe1/frida-multiple-unpinning/
https://codeshare.frida.re/@workwhileweb/ssl/
https://codeshare.frida.re/@fdciabdul/frida-multiple-bypass/
https://codeshare.frida.re/@pcipolloni/universal-android-ssl-pinning-bypass-with-frida/
https://codeshare.frida.re/@kooroshh/ssl-pinning-bypass-okhttp4/
https://codeshare.frida.re/@vadim-a-yegorov/universalunpinner/
https://codeshare.frida.re/@ercu/root-and-bypass-ssl/
https://codeshare.frida.re/@fdciabdul/ovo-bypass-ssl-pinning/
https://codeshare.frida.re/@ivan-sincek/android-ssl-pinning-bypass-2/
...
https://codeshare.frida.re/@acsayson/rootandpinning/
...
setTimeout(function() {
	Java.perform(function() {
		try{
	        ...
	        //com.sensepost.test.TrustManager -- CODESHARE=masbog
	        ...
	        // HttpsURLConnection -- CODESHARE=Q0120S
	        try {
	        ...
	        // NetworkSecurityTrustManager -- CODESHARE=teknogeek
		    try {
		        ...
		        errDict[err] = ['android.security.net.config.NetworkSecurityTrustManager', 'isPinningEnforced'];
		    }
			...
			try {
		        // Bypass WebViewClient {2} -- CODESHARE=ispiropoulos
			...
			// Appmattus -- CODESHARE=Q0120S or workwhileweb
			try {
	            ...
	            console.log('[ ] Appmattus (CertificateTransparencyInterceptor)');
	            errDict[err] = ['com.appmattus.certificatetransparency.internal.verifier.CertificateTransparencyInterceptor', 'intercept'];
	        }
	        ...
	        try {
	            ...
	            console.log('[ ] Appmattus (CertificateTransparencyTrustManager)');
	            errDict[err] = ['com.appmattus.certificatetransparency.internal.verifier.CertificateTransparencyTrustManager', 'checkServerTrusted'];
	        }
			...
			console.log('Error: SSL unpinning stops');
		}
