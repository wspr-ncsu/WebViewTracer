...
type AggregationContext struct {
	...
	PackageName  string             // if present, used to provide the package name of the submission (only used by causality right now)
}
...
type LogInfo struct {
	...
	// What package name is this log associated with?
	PackageName string
...
type ScriptInfo struct {
	...
	// A identifier for all scripts so I don't loose my sanity while joining tables
